...
public interface IArchivoDao {
  ...
  public boolean eliminarPrograma(String idArchivo, String indicePrograma);
  public boolean eliminarAudio(String idArchivo, String indicePrograma, String indiceAudio);
}
